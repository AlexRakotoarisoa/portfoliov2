        ...
        <div className="grid grid-cols-1 md:grid-cols-[320px_1fr]">
          ...
          <div className="bg-[#111B22] p-[2.2rem] flex flex-col justify-between">
            ...
            <a
              ...
              className="hidden mt-[1.8rem] inline-flex  items-center gap-[8px] px-[18px] py-[10px] rounded-[10px] bg-white text-black text-[13px] font-semibold hover:bg-gray-100 transition-all duration-300 w-fit"
            >
              <FaDownload size={12} />
              {t("about.cv")}
            </a>
